...
public class ClusterServiceImpl
    ...
    public MembersView handleMastershipClaim(Address candidateAddress, UUID candidateUuid) {
    ...
    public UUID addMembershipListener(MembershipListener listener) {
    ...
    public boolean removeMembershipListener(UUID registrationId) {
    ...
    private void changeClusterState(
            ClusterState newState, TransactionOptions options, boolean isTransient) {
        long partitionStateStamp = getPartitionStateStamp();
        clusterStateManager.changeClusterState(
                ClusterStateChange.from(newState),
                membershipManager.getMemberMap(),
